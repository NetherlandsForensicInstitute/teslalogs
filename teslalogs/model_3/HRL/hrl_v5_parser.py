...
class HrlV5Parser(KaitaiStruct):
    ...
    class Block(KaitaiStruct):
        ...
        def _read(self):
            ...
            self._raw_records = []
            self.records = []
            for i in range((self.metadata.data_size // 11 - 1)):
                self._raw_records.append(self._io.read_bytes(11))
        ...
        def raw_data(self):
            ...
            _pos = self._io.pos()
            self._io.seek(32)
            self._m_raw_data = self._io.read_bytes((self.metadata.data_size - 11))
            self._io.seek(_pos)
    ...
    class Header(KaitaiStruct):
        ...
        def blocksize(self):
            ...
            self._m_blocksize = (32768 if self.block_size == 0 else self.block_size)
